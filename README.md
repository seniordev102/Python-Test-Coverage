...
- Credentials should be stored securely (environment variables, key management services)
- OAuth2 tokens have limited lifetimes and are automatically refreshed
